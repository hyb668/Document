...
public class HtmlHelper {
    ...
    public static HtmlHelper getInstance() {
        if (htmlHelper == null) {
            synchronized (HtmlHelper.class) {
                htmlHelper = htmlHelper == null ? new HtmlHelper() : htmlHelper;
            }
        }
    ...
    public HtmlHelper webView(WebView webView) {
     ...
     * @return
     */
    public HtmlHelper javaScriptEnabled(boolean enabled) {
     ...
     * @return
     */
    public HtmlHelper scrollBarEnabled(boolean enabled) {
     ...
     * @return
     */
    public HtmlHelper setCacheMode(int mode) {
        /*关闭WebView中缓存*/
     ...
     * @return
     */
    public HtmlHelper applyCacheModeByNetWork() {
     ...
     * @return
     */
    public HtmlHelper setAppCachePath(String cacheDir) {
        webViewCacheDir = Environment.getExternalStorageDirectory().getAbsolutePath() + cacheDir;
