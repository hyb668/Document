...
public class FileUtil {
    ...
    public static boolean mkdirs(String path) {
        ...
        if (!path1.exists()) {
            ...
            //LogUtil.e("创建"+path1.getAbsolutePath()+" 成功 = "+mkdirs);
            return mkdirs;
        }
        return true;
    }
     ...
     */
    public static byte[] getByteByPath(String filePath) {
        File file = new File(filePath);
        if (!file.exists()) {
            return null;
        }
    ...
    /**
     * 获取目标文件夹，下面的所有子文件、子文件夹的 路径
     */
    public static List<File> getChildFileList(String path) {
