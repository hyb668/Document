package com.qiyuan.commons.utils;
...
public class RegexUtils {
	 ...
	 * @return
	 */
	public static boolean isValidPasswor(String password){
		if(null == password){
...
//	}
	...
	public static boolean isBankAccount(String bankAccount){
	    ...
	    return bankAccount.matches("^(\\d{15,23})$");//^(\\d{19}|\\d{16}|\\d{22})$
	}
}
